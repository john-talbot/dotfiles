...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="wombat"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/36/bm6mgl8175vccclzqx25b4fc0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/johntalbot/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/johntalbot/.mailcheckrc"
# }
